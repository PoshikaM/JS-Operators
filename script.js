...
var equal = a===c;
console.log(equal); // (just for understanding) true
...
var stringSeven = b <= c;
console.log(stringSeven); //true

var stringEight = a <= b;
console.log(stringEight); //false
...
var stringNine = a >= b;
console.log(stringNine); //true

var stringTen = d >= c;
console.log(stringTen); //false
